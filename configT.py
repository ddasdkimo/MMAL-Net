...
set = 'projectname'  # Different dataset with different
...
if set == 'CUB':
    ...
    if set == 'CAR':
        ...
        num_classes = 2
    elif set == 'projectname':
        model_path = 'jroject_model_path'      # pth save path
        root = 'project_root'  # dataset path
        num_classes = int('project_num_classes')
'''indice2coordinates'''
